...
<div class="container-fluid">
    <div class="pt-3 ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lesson 1: Prime and Composite Number</li>
            </ol>
        </nav>
    </div>
    <div class="content slideLeft">
      ...
      <section id="content" class="px-3 ">      
        ...
        <center><img src = "../assets/img/Ross.png" class="ross"></center>
        <div class="">
        ...
        <center><img src = "../assets/img/cards.png" class="ross"></center>
        <p class="m-0">
          Ross can arrange his cards in <span class="title" style="color:#F2BC28">1</span>, 
          <span class="title" style="color:#F2BC28">2</span>, 
          <span class="title" style="color:#F2BC28">5</span>, and 
          <span class="title" style="color:#F2BC28">10</span> rows.
        </p>
        <p class="m-0">We can check if our answer is correct with the use of 
          <span class="title" style="color:#F2BC28">Factors&nbsp;</span> and 
          <span class="title" style="color:#F05161">Multiples&nbsp;</span> .</p>
        <div class="row g-sm-1">
          <div class="col-lg-6">
            <div class="box mx-0">
              <span class="title" style="color:#F2BC28">Factors&nbsp;</span> 
              are numbers that we multiply to get a product. 
            </div>
            <div class="box mx-0">
              <span class="title" style="color:#F05161">Multiples&nbsp;</span> 
          ...
          <div class="col-lg-6">
            <div class="box mx-0">
              <p class="ex" style="margin:0px;padding:0px;padding-bottom:2px;">
                <span class="title" style="color:#F2BC28">4&nbsp;</span>
                x&nbsp;
                <span class="title" style="color:#F2BC28">4</span>
                =<span class="title" style="color:#F05161">16</span><i class="bi bi-arrow-right"></i>
                <span class="title factmul" style="color:#F05161;">Multiples</span> 
                <br><i class="bi bi-arrow-down"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="bi bi-arrow-down"></i>
                <br><span class="title factmul ms-2" style="color:#F2BC28;">Factors</span>
              </p> 
            </div>
          </div>
        </div>
        <div>
          <p class="m-0">
            Let us check if 
            <span class="title" style="color:#F2BC28">1</span>,
            <span class="title" style="color:#F2BC28">2</span>, 
            <span class="title" style="color:#F2BC28">5</span>, and
            <span class="title" style="color:#F2BC28">10</span> are
            <span class="title" style="color:#F2BC28">Factors&nbsp;</span>of <span class="title" style="color:#F05161">10</span>.
          </p>
          <div class="row">
            <div class="col-sm-6 text-center">
              <div class="d-flex justify-content-center">
                <div class="ex fact">
                <span class="title" style="color:#F05161">10&nbsp;</span> = <span class="title" style="color:#F2BC28">&nbsp;1&nbsp;</span> x <span class="title" style="color:#F2BC28">&nbsp;10</span>
                </div>
              </div>
              <div><p>
              <span class="title" style="color:#F2BC28">1</span> is a factor of <span class="title" style="color:#F05161">10</span>.<br>
              <span class="title" style="color:#F2BC28">10</span> is a factor of <span class="title" style="color:#F05161">10</span>.</p></div>
            </div>
            <div class="col-sm-6 text-center">
              <div class="d-flex justify-content-center">
                <div class="ex fact">
                <span class="title" style="color:#F05161">10&nbsp;</span> = <span class="title" style="color:#F2BC28">&nbsp;2&nbsp;</span> x <span class="title" style="color:#F2BC28">&nbsp;5</span>
                </div>
              </div>
              <div><p>
              <span class="title" style="color:#F2BC28">2</span> is a factor of <span class="title" style="color:#F05161">10</span>.<br>
              <span class="title" style="color:#F2BC28">5</span> is a factor of <span class="title" style="color:#F05161">10</span>.</p></div>
            </div>
          </div>
          <p class="m-0">Therefore, <span class="title" style="color:#F2BC28">1</span>,
            <span class="title" style="color:#F2BC28">2</span>, 
            <span class="title" style="color:#F2BC28">5</span>, and
            <span class="title" style="color:#F2BC28">10</span> are the 
            <span class="title" style="color:#F2BC28">Factors&nbsp;</span>of 
            <span class="title" style="color:#F05161">10</span>.</p>
        </div>
        <div>
          <p class="m-0">Let us now check if 
            <span class="title" style="color:#F05161">10</span> is a 
            <span class="title factmul" style="color:#F05161;">multiples</span> of 
            <span class="title" style="color:#F2BC28">1</span>,
            <span class="title" style="color:#F2BC28">2</span>, 
            <span class="title" style="color:#F2BC28">5</span>, and
            <span class="title" style="color:#F2BC28">10</span>. Let us multiply these numbers by the numbers
            <span class="title" style="color:#577BA0">0</span>,
            <span class="title" style="color:#577BA0">1</span>,
            <span class="title" style="color:#577BA0">2</span>, 
            <span class="title" style="color:#577BA0">3</span>, . . .</p>
          <center> <img src = "../assets/img/table1.png" class="ross"></center>
          <p class="mb-0">Therefore, <span class="title" style="color:#F05161">10</span> is a 
            <span class="title factmul" style="color:#F05161;">multiples</span> of 
            <span class="title" style="color:#F2BC28">1</span>,
            <span class="title" style="color:#F2BC28">2</span>, 
            <span class="title" style="color:#F2BC28">5</span>, and
            <span class="title" style="color:#F2BC28">10</span>.</p>
        </div>
        <div class="d-flex justify-content-center">
          <div class="fact"><p class="mb-0">
            So, we can finally say that Ross can arrange his cards in <span class="title" style="color:#577BA0">4</span>
            ways (by <span class="title" style="color:#577BA0">1</span>, <span class="title" style="color:#577BA0">2</span>, <span class="title" style="color:#577BA0">5</span>, and <span class="title" style="color:#577BA0">10</span>
            ). </p>
          </div>
        </div>
        <div>
          <center> <img src = "../assets/img/table2.1.png" class="ross"></center>
          <div class="row g-1">
            <div class="col-md-6 d-flex justify-content-center text-center"> 
              <div class="fact mx-0"><p class="mb-0">
                ...
                <span class="title" style="color:#F2BC28">Prime Numbers</span></p>
              </div>
            </div>
            <div class="col-md-6 justify-content-center text-center">
              <div class="fact mx-0"><p class="mb-0">
                ...
                <span class="title" style="color:#F05161">Composite Numbers</span></p>
              </div>
            </div>
          </div>
          <div class="d-flex justify-content-center">
            <div class="fact text-center mx-0"><p class="mb-0">
              A number greater than 1 with only 2 factors is a <span class="title" style="color:#F2BC28">Prime Numbers</span> ex. 7 and 23<br>
              A number with more than 2 factors is a <span class="title" style="color:#F05161">Composite Numbers</span> ex. 9 and 12<br>

    ...
    <div class="ps-3 pt-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="cpnclusion.php">Conclusion</a></li>
            ...
            <div class="boardtext">
                ...
                <table class="pre-l2">
                    ...
                    <tr >
                        <td>1.</td>
                        <td>
                            2 and 4 = <input class="input-num" id="num1"></input>
                        </td>
                        <td>6.</td>
                        <td>
                            6 and 12 = <input class="input-num" id="num6"></input>
                        </td>
                    </tr>
                    <tr>
                        <td>2.</td>
                        <td>
                            3 and 6 = <input class="input-num" id="num2"></input>
                        </td>
                        <td>7.</td>
                        <td>
                            8 and 16 = <input class="input-num" id="num7"></input>
                        </td>
                    </tr>
                    <tr >
                        <td>3.</td>
                        <td>
                            4 and 8 = <input class="input-num" id="num3"></input>
                        </td>
                        <td>8.</td>
                        <td>
                            12 and 15 = <input class="input-num" id="num8"></input>
                        </td>
                    </tr>
                    <tr>
                        <td>4.</td>
                        <td>
                           6 and 9 = <input class="input-num" id="num4"></input>
                        </td>
                        <td>9.</td>
                        <td>
                            9 and 18 = <input class="input-num" id="num9"></input>
                        </td>
                    </tr>
                    <tr>
                        <td>5.</td>
                        <td>
                            10 and 15 = <input class="input-num" id="num5">
                        </td
                        ><td>10.</td>
                        <td>
                            14 and 21 = <input class="input-num" id="num10"></input>
                        </td>
                    </tr>
                    </tbody>
                </table>

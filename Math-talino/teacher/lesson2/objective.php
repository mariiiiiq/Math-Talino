    ...
    <div class="row">
        ...
        <div class="col-md-6 d-md-flex flex-md-column align-items-stretch order-1 order-md-2" data-aos="">
            <h3 class="title mt-5" >Objectives</h3>
                <ol>
                    <li> Write a given number as a product of its prime factors;
                    <li> Find the common factors and the greatest common factor
                        (GCF) of two numbers using the following methods: listing,
                        prime factorization, and continuous division; and
                    <li> Solve real-life problems involving GCF of 2 given numbers.
                </ol>
        </div>
      </div>
      <a href="../../teacher.php" class="title btnback btn btns">Back</a>
      <a href="pretest.php" class="title btnnext btn btns">Next</a>
</div>

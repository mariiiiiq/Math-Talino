...
<div class="container-fluid">
    <div class="ps-3 pt-3">
        <nav aria-label="breadcrumb ">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="lesson.php">Lesson 1</a></li>
        ...
        <div class="col-lg-9 order-1 align-items-stretch order-lg-2 board" data-aos="">
            <div class="boardtext">
                <table style="width:100%;">
                    <tr>
                        <th colspan="2">
                            <h6 class="title text-center">Let us try to see what you have learned about prime and composite numbers.</h6>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="2">
    ...
    <a href="../lesson2/objective.php" class="title next btn btns">Lesson 2</a>
</div>

...
<div class="container-fluid">
        ...
        <div class="board" data-aos="">
            <div class="boardtext">
                <table style="width:100%;">
                    ...
                    <tr>
                        <th colspan="2">
                            <h6 class="title text-center">Let us try to see what you have learned about Least Common Multiple</h6>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="2">
                        <h6 class="text-center">Try to find the LCM of 3 and 4 by climbing the tower by 
    ...
    <a href="../../teacher.php" class="title btnnext btn btns">Lesson list</a>
</div>

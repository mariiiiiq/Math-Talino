    ...
    <div class="ps-3 pt-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="drill.php">Lesson 1</a></li>
                <li class="breadcrumb-item active" aria-current="page">Lesson Video</li>
            </ol>
        </nav>
    </div>
        <video class="vid" width='800' controls>
            <source src="../assets/video/lesson1.mp4" video="web/mp4">
        </video>
      <a href="conclusion.php" class="title next btn btns">Next</a>
</div>

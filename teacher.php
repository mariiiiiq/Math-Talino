  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end mr-5" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="teacher/game.php">Games</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="teacher/accounts.php">Student Accounts</a>
        </li>
        <li class="nav-item">
    ...
    <script>
      ...
      $(document).ready(function(){
        for(let i=1; i<=10;i++){
          ...
          for(let i=1; i<=2;i++){
            $("."+i).click(function() {
              window.location.href="teacher/lesson"+i+"/objective.php";
            });
          }
        }
      });

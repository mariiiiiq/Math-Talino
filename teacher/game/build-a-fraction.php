...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end mr-5" id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="../../teacher.php">Lessons</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../game.php">Games</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container-fluid">
      ...
      <h2 class="title text-center" style="color:#fee440">Build a fraction</h2>

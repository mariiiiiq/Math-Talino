        ...
        <div class="board" data-aos="">
            <div class="boardtext">
                <table style="width:100%;">
                    ...
                    <tr>
                        <th colspan="3">
                          <h6 class="title text-center">Let us see if you know how to identify the different kinds of fractions.</h6>
                        </th>
                    </tr>
                    <tr>
                        <th colspan="3">
                        <h6 class="text-center">Drag <u class="bold">P</u> into the boxes if the given is a Proper Fraction, <u class="bold">I</u> 
        if the given <br>is an Improper fraction and <u class="bold">M</u> if the the given is a Mixed Fraction.</h6>
                        </th>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h4 class="text-center"><span class="title" draggable="true" id="I"><u>I</u></span></h4>
                        </td>
                        <td>
                            <h4 class="text-center"><span class="title" draggable="true" id="M"><u>M</u></span></h4>
                        </td>
                    </tr>
                </table>
                <div class="row ps-3">
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>1.</td>
                        <td>
                          <div class="fraction"><span class="numerator">4</span><span class="denominator">8</span></div> = <input class="dropzone" maxlength="1" id="num1"></input>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>2.</td>
                        <td>
                          6<div class="fraction"><span class="numerator">5</span><span class="denominator">6</span></div> = <input class="dropzone" maxlength="1" id="num2"></input>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>3.</td>
                        <td>
                          <div class="fraction"><span class="numerator">16</span><span class="denominator">18</span></div> = <input class="dropzone" maxlength="1" id="num3">
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>4.</td>
                        <td>
                          <div class="fraction"><span class="numerator">14</span><span class="denominator">12</span></div> = <input class="dropzone" maxlength="1" id="num4"></input>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>5.</td>
                        <td>
                          <div class="fraction"><span class="numerator">20</span><span class="denominator">8</span></div> = <input class="dropzone" maxlength="1" id="num5"></input>
                        </td>
                      </tr>
                    </table>
                  </div>
                  ...
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>6.</td>
                        <td>
                          <div class="fraction"><span class="numerator">18</span><span class="denominator">15</span></div> = <input class="dropzone" maxlength="1" id="num6"></input>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>7.</td>
                        <td>
                          2<div class="fraction"><span class="numerator">3</span><span class="denominator">9</span></div> = <input class="dropzone" maxlength="1" id="num7"></input>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>8.</td>
                        <td>
                          <div class="fraction"><span class="numerator">8</span><span class="denominator">7</span></div> = <input class="dropzone" maxlength="1" id="num8"></input>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>9.</td>
                        <td>
                          <div class="fraction"><span class="numerator">5</span><span class="denominator">12</span></div> = <input class="dropzone" maxlength="1" id="num9"></input>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md d-flex justify-content-center">
                    <table class="">
                      <tr>
                        <td>10.</td>
                        <td>
                          <div class="fraction"><span class="numerator">17</span><span class="denominator">18</span></div> = <input class="dropzone" maxlength="1" id="num10"></input>
                        </td>
                      </tr>
                    </table>
                  </div>

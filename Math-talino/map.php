  ...
  <nav class="navbar navbar-expand-lg navbar-light navbar-border" style="z-index:99999;">
    ...
    <div class="collapse navbar-collapse justify-content-end mr-5" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="map.php">Lessons</a>
        </li>
        <li class="nav-item">
  ...
  <div class="container-fluid">
      ...
      <div class="eggs-lg pt-5 mt-5">
        <div class="row pt-5">
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l1" alt="">
          ...
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l2" alt="">
          ...
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l3" alt="">
          ...
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l4" alt="">
          ...
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l5" alt="">
        ...
        <div class="row mt-5 pt-5">
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l6" alt="">
          ...
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l7" alt="">
          ...
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l8" alt="">
          ...
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l9" alt="">
          ...
          <div class="col-2 d-flex justify-content-center">
            <div class="eggdiv tossing" style="">
              <img src="assets/img/lock.png" class="lock l10" alt="">
      ...
      $(document).ready(function(){
        ...
        $.ajax({
          ...
          success:function(data)
          {
            ...
            for(let j=1;j<=10;j++){
              let unlocked = $(".l"+j).css('display');
              if(unlocked=='none'){
                $("."+j).click(function() {
                    window.location.href="lesson"+j+"/objective.php";
                  });
                  $("."+j).mouseenter(function() {
                    $(".crack"+j).css('display', 'inline-block');
                  });
                  $("."+j).mouseleave(function() {
                    $(".crack"+j).css('display', 'none');
                  });
              }
              else{

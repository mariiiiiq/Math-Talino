...
<div class="container-fluid">
    ...
    <div class="content slideLeft">
      ...
      <section id="content" class="px-3 ">      
        ...
        Let us try the this mini activity!</p>
        <div class="row">
          ...
          <div class="col order-1 order-md-2">
            ...
            <ol class="m-0"> 
              <li>  Click the special number
              <li>  Click all prime numbers
              <li>  Click all composite numbers
            </ol>
            <div class=" justify-content-center msgdiv my-0" style="display:none;">
              <div class="fact text-center align-items-center mx-0">
                <p class="mb-0 msg">asdas
                </p>
              </div>
              <img src = '../assets/img/objcircle.png' class='owlgood' style="display:none;transform:scaleX(-1);float:right;width:30%;"> 
            </div> 
    ...
    <script>
      ...
      $(document).ready(function () {
          $('#btn1').click(function(){
            ...
            $('.msg').html("That's right! 1 is a Special Number. Good job!");
            $('.owlgood').css("display", "block");
          });
          let exis = "<img src = '../assets/img/exis.png' class='exis'>";
          let check = "<img src = '../assets/img/check.png' class='exis'>";
          for(let i=1;i<=100;i++){
          ...
          function composite(i){
            var msg = "That's right! " +i+" is a Prime Number. Good job!";
            var msg1 = "That's right! " +i+" is a Composite Number. Nice!";
            let composite = false;
            if(i%2==0 && i!=2){
              composite = true;
            }

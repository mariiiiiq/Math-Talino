    ...
    <div class="collapse navbar-collapse justify-content-end mr-5" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="" id="<?php echo $_SESSION['user'];?>" data-bs-toggle="dropdown" aria-expanded="false">
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-6 d-md-flex flex-md-column align-items-stretch order-1 order-md-2" data-aos="">
            <h3 class="title mt-5" >Objectives</h3>
                <ol>
                    <li> Visualize addition and subtraction of similar fractions;
                    <li> Perform addition and subtraction of similar fractions; and
                    <li> Solve word problems involving addition and/or subtraction of similar fractions.
                </ol>
                <table><tr><td ><a href="../lesson5.1/pretest.php" ><img src="../assets/img/woodtile5.1.png" class="w-100 5-1" alt=""></a></div></td>
                <td><img src="../assets/img/woodtile5.2.png" class="w-100 5-2" alt=""></td><tr></table>
        </div>
      </div>
...
<img src="../assets/img/objleaves2.png" class="objl2" alt="">
    ...
    <script>
        ...
        $(".5-1").mouseenter(function(){
          $('.5-1').addClass('floating');
        });
        $(".5-1").mouseleave(function(){
          $('.5-1').removeClass('floating');
        });
        $(".5-2").mouseenter(function(){
          $('.5-2').addClass('floating');
        });
        $(".5-2").mouseleave(function(){
          $('.5-2').removeClass('floating');
        });
        $.ajax({
          type:'POST',
          url:'l5.php',
          ...
          success:function(data)
          {
            ...
            $('.5-2').click(function(){
              if(data>0){
                window.location.href="../lesson5.2/pretest.php";
              }
            });
          }
        });

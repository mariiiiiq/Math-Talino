      ...
      <section id="content" class="px-3 ">      
        ...
        <div class="">
          ...
          <p>What are the given facts that can help you solve the problem?<br>
            <span><i class="bi bi-patch-question mx-2 ps-4"></i>8 red gumamela flowers, 12 pink gumamela flowers
            </span>
          </p>
          <p>What can you say about Nancy? What kind of person is she?<br>
            <span><i class="bi bi-patch-question mx-2 ps-4"></i>Nancy is grateful to have her teachers. She is
              thoughtful.</span>
          </p>
        </div>
        <p class="m-0">The problem is about finding the greatest common factor
          ...
          that we can make with the red and pink flowers.<br><span style="color:#F05161">Let's try to solve it!</p> 
        ...
        <div class="pt-2" style="border-top:2px solid #9b9b7a">
          ...
          <div class="d-flex justify-content-center">
            <div class="fact">
              <p class="mb-0">Therefore, <span class="title" style="color:#577BA0;">4</span> is the greatest possible number of vases that Nancy can use.</p>
            </div>
          </div>
        </div>
    </section>

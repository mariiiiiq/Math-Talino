...
<div class="container-fluid">
    ...
    <div class="content slideLeft">
      ...
      <section id="content" class="px-3 ">      
        ...
        <center><img src = "../assets/img/rachel.png" class="prob"></center>
        <div class="">
        ...
        <div class="d-flex justify-content-left">
          ...
          <span class="title blue">Greatest Common Factor</span> (GCF) is the biggest factor or number common to the given numbers.</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="row g-1">
            <div class="col-sm-6">
              Step 1: List the factors of <span class="title yel">8</span> and <span class="title yel">12</span>.
            ...
            <div class="col-sm-6">
              <p class="mb-0">
                ...
                &nbsp;&nbsp;Factors of <span class="title yel">8</span>: <u>1 , 2 , 4 and 8</u><br>
                &nbsp;&nbsp;Factors of <span class="title yel">12</span>: <u>1 , 2 , 3 , 4 , 6 and 12</u><br>
                Step 3: Find the common factor/s of <span class="title yel">8</span> and <span class="title yel">12</span> (red numbers).<br>
                &nbsp;&nbsp;Factors of <span class="title yel">8</span>: <u><span class="title red">1</span>, <span class="title red">2</span>, <span class="title red">4</span> and 8</u><br>
                &nbsp;&nbsp;Factors of <span class="title yel">12</span>: <u><span class="title red">1</span>, <span class="title red">2</span>, 3, <span class="title red">4</span> , 6 and 12</u>
          ...
          <div class="d-flex justify-content-center">
            <div class="fact">
              <p class="mb-0"><span class="title red">Greatest Common Factor</span> (GCF) : <u> 4</u></p>
            </div>
          </div>
        </div>
        <div class="pt-2" style="border-top:2px solid #9b9b7a">
          <p class="m-0">&nbsp;&nbsp;&nbsp;&nbsp;In the next 2 ways of finding the greatest common factor of two numbers, 
            ...
            prime factors, we have the <span class="title blue">Prime Factorization</span> of the number. For example, the number 16 can be written as a product of 
          ...
          <div class="row g-1">
            <div class="col-sm-6">
              <div class="d-flex justify-content-center">
                <div class="fact">
                  <p class="mb-0"><span class="title red">Factor Tree</span> is a diagram used to determine the prime factors of a number.</p>
                </div>
              </div>
              <div class="row">
                <div class="col-4">
                  <img src = "../assets/img/factortree.png" class="prob" style="float:right">
                </div>
                <div class="col">
                  <p>
            ...
            <div class="col-sm-6">
              <div class="d-flex justify-content-center">
                <div class="fact">
                  <p class="mb-0">In <span class="title yel">Continuous Division</span>, we need to divide number by its prime factor and continue dividing until we reach the quotient 1.</p>
                </div>
              </div>
              <div class="row">
                <div class="col-4">
                  <img src = "../assets/img/division.png" class="prob" style="float:right">
                </div>
                <div class="col">
                  <p>
                    The number 16 can be written in prime factorization as 2 x 2 x 2 x 2. All of the factors are prime numbers.
          ...
          <div class="d-flex justify-content-center">
            <div class="fact">
              <p class="mb-0">The expression "2 x 2 x 2 x 2" is said to be the <span class="title blue">Prime Factorization</span> of 16.</p>
            </div>
          </div>
          <div>
            <div class="d-flex justify-content-start">
              <div class="fact"><p class="mb-0">
                Method 2: <span class="title red"><u>Prime Factorization</u></span></p>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-6 d-flex justify-content-end">
                    <img src = "../assets/img/method2.png" class="prob">
                  </div>
                  <div class="col-6">
                    <img src = "../assets/img/method2.2.png" class="prob">
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <p class="m-0">
                  Step 2: List down the prime factors of <span class="title red">8</span> and <span class="title red">12</span>.
                  <br><span class="ps-5">8 = 2 x 2 x 2</span><br><span class="ps-5">12 = 2 x 2 x 3</span>
                </p>
               <p class="m-0">Step 3: Multiply the common prime factors of <span class="title red">8</span> and <span class="title red">12</span> to get the GCF.</p>
          ...
          <div>
            ...
            <div class="d-flex justify-content-center">
              <div class="fact">
                <p class="mb-0"><span class="title yel">Greatest Common Factor</span> (GCF) : <u> 4</u></p>
              </div>
            </div>
          </div>
          <div class="d-flex justify-content-center">
            <div class="fact">
              <p class="mb-0">Therefore, <span class="title blue">4</span> is the greatest possible number of vases that Rachel can use.</p>
            </div>
          </div>
        </div>
      </div>
